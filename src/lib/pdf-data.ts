...
export const NEUROCOGNITIVE_DATA: Record<string, TalentData> = {
  ...
  aplicado: {
    ...
    resumen: 'Perfil que demuestra facilidad de adaptación al trabajo rutinario, así como constancia y responsabilidad para cumplir retos y objetivos con una alta capacidad funcional.',
    detalle: 'Perfil que demuestra facilidad de adaptación al trabajo rutinario, así como constancia y responsabilidad para cumplir retos y objetivos con una alta capacidad funcional y de proyección hacia el equipo de trabajo. Cumplen, son responsables y logran los objetivos que les han sido encomendados.',
  ...
  empatico: {
    ...
    resumen: 'Perfil que prioriza el bienestar de las personas, acompañarlas es una prioridad. Se caracteriza por su intuición y también por su compromiso y altruismo.',
  ...
  analitico: {
    ...
    resumen: 'Perfil que muestra interés por la investigación y pasión por el descubrimiento. Es habitual que genere ideas innovadoras. Les atrae el mundo de la ciencia y la adquisición de conocimientos.',
  ...
  profundo: {
    ...
    resumen: 'Perfil que muestra mucha sensibilidad y profundidad en la forma de percibir el mundo. También destaca por tener una gran intuición. Suelen sentir atracción por temas ocultos o no evidentes.',
    detalle: 'Perfil que muestra sensibilidad y profundidad en la manera de percibir el mundo, tanto personal como profesional. Suelen sentir atracción por temas ocultos o no evidentes y que requieren introspección, intuición, investigación y profundidad.',
  ...
  imaginacion: {
    ...
    resumen: 'Perfil que se caracteriza por su pasión por la creatividad y suele destacar por su gran imaginación e inventiva, aplicada a todos los ámbitos profesionales.',
  ...
  gestion: {
    ...
    resumen: 'Perfil que muestra capacidad de gestión y organización, también, para seguir, proponer y dirigir retos. Pueden ser emprendedores y muestran iniciativas para conseguir sus objetivos.',
